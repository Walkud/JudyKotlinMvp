...
class HomeFragment : MvpFragment<HomePresenter>() {
     ...
     * 获取刷新控件事务
     */
    override fun getSmartRefreshProgressView(): ProgressView {
        return ProgressView.SmartRefreshProgress(mRefreshLayout)
    }

    /**
     * 获取进度、错误、内容切换View事务
     */
    override fun getMultipleStatusProgressView(): ProgressView {
        return ProgressView.MultipleStatusProgress(multipleStatusView)
    }
